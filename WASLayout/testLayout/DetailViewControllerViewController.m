...
- (void)viewDidLoad
{
    ...
    UILabel *label1 = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 300, 40)];
    UILabel *label2 = [[UILabel alloc] initWithFrame:CGRectMake(0, 40, 100, 40)];
    UILabel *label3 = [[UILabel alloc] initWithFrame:CGRectMake(0, 80, 200, 40)];
    UILabel *label4 = [[UILabel alloc] initWithFrame:CGRectMake(0, 120, 100, 40)];
    UILabel *label5 = [[UILabel alloc] initWithFrame:CGRectMake(0, 160, 100, 40)];
...
- (void)viewDidLoad
{
    ...
    UILabel *label1 = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 300, 40)] ;
    UILabel *label2 = [[UILabel alloc] initWithFrame:CGRectMake(0, 40, 100, 60)] ;
    UILabel *label3 = [[UILabel alloc] initWithFrame:CGRectMake(0, 80, 50, 30)] ;
    UILabel *label4 = [[UILabel alloc] initWithFrame:CGRectMake(0, 120, 50, 22)] ;
    UILabel *label5 = [[UILabel alloc] initWithFrame:CGRectMake(0, 160, 70, 50)] ;
    label1.textAlignment = NSTextAlignmentCenter;
    label2.textAlignment = NSTextAlignmentCenter;
    label3.textAlignment = NSTextAlignmentCenter;
    label4.textAlignment = NSTextAlignmentCenter;
...
- (void)viewDidLoad
{
    ...
    UILabel *label1 = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 300, 40)] ;
    UILabel *label2 = [[UILabel alloc] initWithFrame:CGRectMake(0, 40, 100, 60)] ;
    UILabel *label3 = [[UILabel alloc] initWithFrame:CGRectMake(0, 80, 230, 30)] ;
    UILabel *label4 = [[UILabel alloc] initWithFrame:CGRectMake(0, 120, 50, 22)] ;
    UILabel *label5 = [[UILabel alloc] initWithFrame:CGRectMake(0, 160, 70, 50)] ;
    label1.textAlignment = NSTextAlignmentCenter;
    label2.textAlignment = NSTextAlignmentCenter;
...
- (void) addcomponent:(int ) count
{
    for (int i = 0 ; i < count; i++) {
        UILabel *label1 = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 30, 40)] ;
        label1.textAlignment = NSTextAlignmentCenter;
...
- (void)viewDidLoad
{
    ...
    WASBoxLayout *boxLayout = [[WASBoxLayout alloc] initWithContainer:self.container axis:WASBoxLayout.Y_AXIS] ;
    [self.container setLayoutManager:boxLayout];

    
    UILabel *label1 = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 30, 40)] ;
    UILabel *label2 = [[UILabel alloc] initWithFrame:CGRectMake(0, 40, 10, 60)] ;
    UILabel *label3 = [[UILabel alloc] initWithFrame:CGRectMake(0, 80, 23, 30)] ;
    UILabel *label4 = [[UILabel alloc] initWithFrame:CGRectMake(0, 120, 50, 22)] ;
    UILabel *label5 = [[UILabel alloc] initWithFrame:CGRectMake(0, 160, 70, 50)] ;
    label1.textAlignment = NSTextAlignmentCenter;
    label2.textAlignment = NSTextAlignmentCenter;
