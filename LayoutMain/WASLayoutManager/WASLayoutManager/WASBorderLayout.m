...
@property (nonatomic, retain) Component *center;
@property (nonatomic, retain) Component *north;
@property (nonatomic, retain) Component *south;
@property (nonatomic, retain) Component *east;
@property (nonatomic, retain) Component *west;
...
{
    return [NSString stringWithFormat:@"%@ [hgap = %f, vgap = %f ] ",NSStringFromClass([self class]), self.hgap, self.vgap];
}
